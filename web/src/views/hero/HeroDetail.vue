  ...
  <div id="hero-detail" v-if="heroDetail">
    <div class="topbar">
      ...
      <router-link tag="div" to="/more/heroList" class="more"
        >更多英雄<span class="gt">&gt;</span></router-link
      >
    </div>
    <!-- end of tapbar -->
          ...
          <div class="other">
            <div class="score">
              <div class="score-item">
                难度
                <span class="badge badge-difficult radius-round">{{
                  heroDetail.score.difficult
                }}</span>
              </div>
              <div class="score-item">
                技能
                ...
                <div class="skill-info">
                  <div class="basic">
                    ...
                    <span class="consume">
                      ...
                      {{ heroDetail.skills[skillActive].consume }})
                    </span>
                  </div>
                  <div class="description">
                    {{ heroDetail.skills[skillActive].description }}
                  </div>
                </div>
              </div>
            </div>
                ...
                <template v-slot:content>
                  <div class="equip">
                    ...
                    <div class="equip-wrap border">
                      <div
                        class="equip-item"
                        v-for="(item, index) in heroDetail.luckyEquip"
                        :key="index"
                      >
                  ...
                  <div class="equip">
                    ...
                    <div class="equip-wrap">
                      <div
                        class="equip-item"
                        v-for="(item, index) in heroDetail.shitEquip"
                        :key="index"
                      >
                        <img :src="item.icon" class="icon radius-round" alt="equip-icon" />
                        <div class="name">{{ item.name }}</div>
              ...
              <m-card title="铭文推荐" icon="icon_store.png" :more="false">
                <template v-slot:content>
                  <div class="store">
                    <div
                      class="store-item"
                      v-for="(item, index) in heroDetail.storeRecommend"
                      :key="index"
                    >
                      <div class="icon">
                      ...
                      <div class="info">
                        ...
                        <div class="attr" v-for="(attr, i) in item.attr" :key="i">
                          {{ attr }}
                        </div>
                      </div>
                    </div>
...
export default {
  ...
  methods: {
    ...
    async fetchHero() {
      ...
      this.heroDetail = Object.assign({}, this.heroDetail, res.data)
      // 保存皮肤数据到本地
