<template>
  <div id="ads-list">
    ...
    <el-table :data="adsList" border style="width: 100%">
      ...
      <el-table-column prop="name" label="广告位名称" width="550"> </el-table-column>
      <el-table-column prop="adNum" label="广告数量" width="350"> </el-table-column>
      <el-table-column label="操作">
        <template slot-scope="scope">
          <el-button size="mini" @click="$router.push(`/system/adsUpdate/${scope.row._id}`)"
            >编辑</el-button
          >
          <el-button size="mini" type="danger" @click="deleteAds(scope.row)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
  </div>
