<template>
  <div id="hero-list">
    ...
    <el-table :data="heroList" border style="width: 100%">
      ...
      <el-table-column prop="categoryName" label="所属分类" width="350"> </el-table-column>
      <el-table-column label="操作">
        <template slot-scope="scope">
          <el-button size="mini" @click="$router.push(`/hero/heroUpdate/${scope.row._id}`)"
            >编辑</el-button
          >
          <el-button size="mini" type="danger" @click="deleteHero(scope.row)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <div class="page">
