    ...
    <el-form label-position="right" label-width="100px" :model="model">
      <el-tabs type="border-card" v-model="tabIndex">
        <el-tab-pane name="one" label="基本信息" class="tab-pane-one">
          ...
          <el-form-item label="背景图" class="star-right">
            <el-upload
              class="avatar-uploader"
              :action="uploadUrl"
              :show-file-list="false"
        ...
        <el-tab-pane name="four" label="英雄关系" class="tab-pane-four">
          ...
          <el-row type="flex" style="flex-wrap: wrap" :gutter="30">
            ...
            >
              ...
              <el-form-item>
                <el-button type="danger" size="small" @click="delHeroRelate(index, 'partners')"
                  >删除</el-button
                >
              </el-form-item>
            </el-col>
          ...
          <el-row type="flex" style="flex-wrap: wrap" :gutter="30">
            ...
            >
              ...
              <el-form-item>
                <el-button type="danger" size="small" @click="delHeroRelate(index, 'enemies')"
                  >删除</el-button
                >
              </el-form-item>
            </el-col>
          ...
          <el-row type="flex" style="flex-wrap: wrap" :gutter="30">
            ...
            >
              ...
              <el-form-item>
                <el-button type="danger" size="small" @click="delHeroRelate(index, 'preies')"
                  >删除</el-button
                >
              </el-form-item>
            </el-col>
